...
try:
    ...
    Font1 = ImageFont.truetype("/home/anuragthokala/Downloads/Arimo-Regular.ttf",25)
    Font2 = ImageFont.truetype("/home/anuragthokala/Downloads/Arimo-Regular.ttf",35)
    Font3 = ImageFont.truetype("/home/anuragthokala/Downloads/Arimo-Regular.ttf",32)
    fruits = ["apple", "banana", "cherry"]
    for x in fruits:
        print(x)
        disp.clear()
        draw.rectangle([(0,65),(140,100)],fill = "WHITE")
        draw.text((5, 68), x, fill = "BLACK",font=Font1)
        disp.ShowImage(image1)
        time.sleep(1)
        disp.clear()
    
    #draw.rectangle([(0,115),(190,160)],fill = "RED")
    #draw.text((5, 118), 'TEST', fill = "WHITE",font=Font2)
    #draw.text((5, 160), '69420', fill = "GREEN",font=Font3)
        #text= u"微雪电子"
        #raw.text((5, 200),text, fill = "BLUE",font=Font3)
